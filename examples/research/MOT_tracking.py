...
TASK_NAME = 'MOT-20_shift_30_frames_test_conncomp'
SEG_MODEL = 'main'
MASK = 'mask'
BBOX1 = 'bbox1'
BBOX2 = 'bbox2'
...
d = df.groupby(['video'])['frame_id'].max()
val_video = [d.index[d.argmin()]]

train_video = [v for v in video_list if v not in val_video]
